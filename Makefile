...
.PHONY: test-e2e-worker-unavailable
test-e2e-worker-unavailable:
	postman collection run --color on --verbose ./postman/worker_unavailable_collection.json -e ./postman/environments/$(POSTMAN_ENV).json
