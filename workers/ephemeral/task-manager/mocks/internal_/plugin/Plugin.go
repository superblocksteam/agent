...
// Plugin_Close_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Close'
type Plugin_Close_Call struct {
	*mock.Call
}

// Close is a helper method to define mock.On call
func (_e *Plugin_Expecter) Close() *Plugin_Close_Call {
	return &Plugin_Close_Call{Call: _e.mock.On("Close")}
}

func (_c *Plugin_Close_Call) Run(run func()) *Plugin_Close_Call {
...
func (_c *Plugin_Close_Call) Return() *Plugin_Close_Call {
	_c.Call.Return()
	return _c
}

func (_c *Plugin_Close_Call) RunAndReturn(run func()) *Plugin_Close_Call {
	_c.Run(run)
	return _c
}
