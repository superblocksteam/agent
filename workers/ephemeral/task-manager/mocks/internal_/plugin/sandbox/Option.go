...
func (_m *Option) Execute(_a0 *sandbox.Options) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *sandbox.Options)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*sandbox.Options))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*sandbox.Options)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
