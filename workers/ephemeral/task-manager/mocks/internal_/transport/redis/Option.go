...
import (
	redis "workers/ephemeral/task-manager/internal/transport/redis"
...
func (_m *Option) Execute(_a0 *redis.Options) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *redis.Options)) *Option_Execute_Call {
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*redis.Options)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
