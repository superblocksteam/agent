...
func init() {
	...
	pflag.StringSlice("worker.plugins.image.use_lang_executor", []string{}, "The list of plugins that use the language executor image. Defaults to 'javascript' and 'python'.")
