...
export class AkeylessSecretsManager extends jspb.Message { 

    hasAuth(): boolean;
    clearAuth(): void;
    getAuth(): plugins_common_v1_auth_pb.AkeylessAuth | undefined;
    setAuth(value?: plugins_common_v1_auth_pb.AkeylessAuth): AkeylessSecretsManager;

    hasHost(): boolean;
    clearHost(): void;
    getHost(): string | undefined;
    setHost(value: string): AkeylessSecretsManager;

    hasPrefix(): boolean;
    clearPrefix(): void;
    getPrefix(): string | undefined;
    setPrefix(value: string): AkeylessSecretsManager;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): AkeylessSecretsManager.AsObject;
    static toObject(includeInstance: boolean, msg: AkeylessSecretsManager): AkeylessSecretsManager.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: AkeylessSecretsManager, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): AkeylessSecretsManager;
    static deserializeBinaryFromReader(message: AkeylessSecretsManager, reader: jspb.BinaryReader): AkeylessSecretsManager;
}

export namespace AkeylessSecretsManager {
    export type AsObject = {
        auth?: plugins_common_v1_auth_pb.AkeylessAuth.AsObject,
        host?: string,
        prefix?: string,
    }
}
...
export class Provider extends jspb.Message { 
    ...
    hasAkeylessSecretsManager(): boolean;
    clearAkeylessSecretsManager(): void;
    getAkeylessSecretsManager(): AkeylessSecretsManager | undefined;
    setAkeylessSecretsManager(value?: AkeylessSecretsManager): Provider;
...
export namespace Provider {
    export type AsObject = {
        ...
        akeylessSecretsManager?: AkeylessSecretsManager.AsObject,
