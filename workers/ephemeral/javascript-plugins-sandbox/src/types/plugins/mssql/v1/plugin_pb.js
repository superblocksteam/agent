...
proto.plugins.mssql.v1.Plugin.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.plugins.mssql.v1.MappedColumns.toObject, includeInstance),
...
proto.plugins.mssql.v1.Plugin.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      10,
      f,
      proto.plugins.mssql.v1.MappedColumns.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.plugins.mssql.v1.SuperblocksMetadata.serializeBinaryToWriter
    );
  }
 ...
 * @return {string}
 */
proto.plugins.mssql.v1.Plugin.prototype.getParameters = function() {
 ...
 * @return {!proto.plugins.mssql.v1.Plugin} returns this
 */
proto.plugins.mssql.v1.Plugin.prototype.setParameters = function(value) {
 ...
 * @return {!proto.plugins.mssql.v1.Plugin} returns this
 */
proto.plugins.mssql.v1.Plugin.prototype.clearParameters = function() {
 ...
 * @return {boolean}
 */
proto.plugins.mssql.v1.Plugin.prototype.hasParameters = function() {
