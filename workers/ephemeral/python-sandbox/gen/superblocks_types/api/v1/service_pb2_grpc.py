...
def add_MetadataServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('api.v1.MetadataService', rpc_method_handlers)
...
def add_DeprecatedServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('api.v1.DeprecatedService', rpc_method_handlers)
