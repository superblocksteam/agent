...
def test_constant_defaults():
    ...
    try:
        ...
        assert SUPERBLOCKS_PYTHON_EXECUTION_IMPORT_ALLOW_LIST == ["*"]
        assert SUPERBLOCKS_PYTHON_EXECUTION_IMPORT_DENY_LIST == []
        assert SUPERBLOCKS_PYTHON_EXECUTION_BUILTINS_DENY_LIST == []
