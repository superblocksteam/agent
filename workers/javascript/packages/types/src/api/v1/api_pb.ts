...
import { Plugin as Plugin$37 } from "../../plugins/javascriptsdkapi/v1/plugin_pb.js";
import { Plugin as Plugin$38 } from "../../plugins/snowflakepostgres/v1/plugin_pb.js";
...
export class Step extends Message<Step> {
  ...
  config: {
    ...
    /**
     * @generated from field: plugins.restapiintegration.v1.Plugin snowflakecortex = 82;
     */
    value: Plugin$12;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 82, name: "snowflakecortex", kind: "message", T: Plugin$12, oneof: "config" },
  ]);
