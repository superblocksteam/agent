...
exports.Plugin = exports.SuperblocksMetadata = exports.Tuple = exports.MappedColumns = exports.Metadata = exports.Table = exports.Index = void 0;
const protobuf_1 = require("@bufbuild/protobuf");
/**
 * @generated from message plugins.dynamodb.v1.Index
 */
class Index extends protobuf_1.Message {
    /**
    ...
    static typeName = "plugins.dynamodb.v1.Index";
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(Index, a, b);
    }
}
exports.Index = Index;
/**
...
class Table extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.Table";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
        { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 2, name: "partitionKey", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 3, name: "sortKey", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
class Metadata extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.Metadata";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class MappedColumns extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.MappedColumns";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class Tuple extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.Tuple";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class SuperblocksMetadata extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.SuperblocksMetadata";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class Plugin extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.dynamodb.v1.Plugin";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
