...
// @generated from file plugins/redshift/v1/plugin.proto (package plugins.redshift.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
class SuperblocksMetadata extends protobuf_1.Message {
    ...
    static typeName = "plugins.redshift.v1.SuperblocksMetadata";
...
class MappedColumns extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.redshift.v1.MappedColumns";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class Tuple extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.redshift.v1.Tuple";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class Plugin extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.redshift.v1.Plugin";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
