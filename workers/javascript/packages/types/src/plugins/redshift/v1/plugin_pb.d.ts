...
/**
 * @generated from message plugins.redshift.v1.SuperblocksMetadata
 */
export declare class SuperblocksMetadata extends Message<SuperblocksMetadata> {
    ...
    static readonly typeName = "plugins.redshift.v1.SuperblocksMetadata";
...
/**
 * @generated from message plugins.redshift.v1.MappedColumns
 */
export declare class MappedColumns extends Message<MappedColumns> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.redshift.v1.MappedColumns";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.redshift.v1.Tuple
 */
export declare class Tuple extends Message<Tuple> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.redshift.v1.Tuple";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.redshift.v1.Plugin
 */
export declare class Plugin extends Message<Plugin> {
    ...
    table: string;
    /**
     * @generated from field: repeated plugins.redshift.v1.Tuple newValues = 6;
     */
    newValues: Tuple[];
    /**
     * @generated from field: repeated plugins.redshift.v1.Tuple oldValues = 7;
     */
    oldValues: Tuple[];
    /**
    ...
    mappingMode: string;
    /**
     * @generated from field: repeated plugins.redshift.v1.MappedColumns mappedColumns = 10;
     */
    mappedColumns: MappedColumns[];
    /**
     * @generated from field: plugins.redshift.v1.SuperblocksMetadata superblocksMetadata = 11;
     */
    superblocksMetadata?: SuperblocksMetadata;
    constructor(data?: PartialMessage<Plugin>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.redshift.v1.Plugin";
    static readonly fields: FieldList;
