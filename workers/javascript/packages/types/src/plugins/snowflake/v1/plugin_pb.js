...
// @generated from file plugins/snowflake/v1/plugin.proto (package plugins.snowflake.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
class MappedColumns extends protobuf_1.Message {
    ...
    static typeName = "plugins.snowflake.v1.MappedColumns";
...
class Tuple extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.snowflake.v1.Tuple";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class SuperblocksMetadata extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.snowflake.v1.SuperblocksMetadata";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
...
class Plugin extends protobuf_1.Message {
    ...
    static runtime = protobuf_1.proto3;
    static typeName = "plugins.snowflake.v1.Plugin";
    static fields = protobuf_1.proto3.util.newFieldList(() => [
