...
/**
 * @generated from message plugins.mysql.v1.MappedColumns
 */
export declare class MappedColumns extends Message<MappedColumns> {
    ...
    static readonly typeName = "plugins.mysql.v1.MappedColumns";
...
/**
 * @generated from message plugins.mysql.v1.Tuple
 */
export declare class Tuple extends Message<Tuple> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.mysql.v1.Tuple";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.mysql.v1.SuperblocksMetadata
 */
export declare class SuperblocksMetadata extends Message<SuperblocksMetadata> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.mysql.v1.SuperblocksMetadata";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.mysql.v1.Plugin
 */
export declare class Plugin extends Message<Plugin> {
    ...
    mappingMode?: string;
    /**
     * @generated from field: repeated plugins.mysql.v1.MappedColumns mappedColumns = 10;
     */
    mappedColumns: MappedColumns[];
    /**
     * @generated from field: plugins.mysql.v1.SuperblocksMetadata superblocksMetadata = 11;
     */
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.mysql.v1.Plugin";
    static readonly fields: FieldList;
