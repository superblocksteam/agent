...
/**
 * @generated from message plugins.rockset.v1.SuperblocksMetadata
 */
export declare class SuperblocksMetadata extends Message<SuperblocksMetadata> {
    ...
    static readonly typeName = "plugins.rockset.v1.SuperblocksMetadata";
...
/**
 * @generated from message plugins.rockset.v1.MappedColumns
 */
export declare class MappedColumns extends Message<MappedColumns> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.rockset.v1.MappedColumns";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.rockset.v1.Tuple
 */
export declare class Tuple extends Message<Tuple> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.rockset.v1.Tuple";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.rockset.v1.Plugin
 */
export declare class Plugin extends Message<Plugin> {
    ...
    operation?: string;
    /**
     * @generated from field: string useAdvancedMatching = 4;
     */
    ...
    table: string;
    /**
     * @generated from field: repeated plugins.rockset.v1.Tuple newValues = 6;
     */
    newValues: Tuple[];
    /**
     * @generated from field: repeated plugins.rockset.v1.Tuple oldValues = 7;
     */
    oldValues: Tuple[];
    /**
    ...
    filterBy: string[];
    /**
     * @generated from field: string mappingMode = 9;
     */
    mappingMode: string;
    /**
     * @generated from field: repeated plugins.rockset.v1.MappedColumns mappedColumns = 10;
     */
    mappedColumns: MappedColumns[];
    /**
     * @generated from field: string httpMethod = 11;
     */
    httpMethod: string;
    /**
     * @generated from field: plugins.rockset.v1.SuperblocksMetadata superblocksMetadata = 12;
     */
    superblocksMetadata?: SuperblocksMetadata;
    constructor(data?: PartialMessage<Plugin>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.rockset.v1.Plugin";
    static readonly fields: FieldList;
