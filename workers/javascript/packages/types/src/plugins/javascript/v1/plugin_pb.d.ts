...
/**
 * @generated from message plugins.javascript.v1.SuperblocksMetadata
 */
export declare class SuperblocksMetadata extends Message<SuperblocksMetadata> {
    ...
    static readonly typeName = "plugins.javascript.v1.SuperblocksMetadata";
...
/**
 * @generated from message plugins.javascript.v1.Plugin
 */
export declare class Plugin extends Message<Plugin> {
    ...
    body: string;
    /**
     * @generated from field: plugins.javascript.v1.SuperblocksMetadata superblocksMetadata = 2;
     */
    superblocksMetadata?: SuperblocksMetadata;
    constructor(data?: PartialMessage<Plugin>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.javascript.v1.Plugin";
    static readonly fields: FieldList;
