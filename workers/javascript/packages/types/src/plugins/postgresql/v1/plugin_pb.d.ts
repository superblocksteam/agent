...
/**
 * @generated from message plugins.postgresql.v1.SuperblocksMetadata
 */
export declare class SuperblocksMetadata extends Message<SuperblocksMetadata> {
    ...
    static readonly typeName = "plugins.postgresql.v1.SuperblocksMetadata";
...
/**
 * @generated from message plugins.postgresql.v1.MappedColumns
 */
export declare class MappedColumns extends Message<MappedColumns> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.postgresql.v1.MappedColumns";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.postgresql.v1.Tuple
 */
export declare class Tuple extends Message<Tuple> {
    ...
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.postgresql.v1.Tuple";
    static readonly fields: FieldList;
...
/**
 * @generated from message plugins.postgresql.v1.Plugin
 */
export declare class Plugin extends Message<Plugin> {
    ...
    mappingMode?: string;
    /**
     * @generated from field: repeated plugins.postgresql.v1.MappedColumns mappedColumns = 10;
     */
    mappedColumns: MappedColumns[];
    /**
     * @generated from field: plugins.postgresql.v1.SuperblocksMetadata superblocksMetadata = 12;
     */
    superblocksMetadata?: SuperblocksMetadata;
    /**
     * @generated from field: optional string insertedRows = 13;
     */
    insertedRows?: string;
    /**
     * @generated from field: optional string deletedRows = 14;
     */
    deletedRows?: string;
    /**
     * @generated from field: optional string schema = 15;
     */
    schema?: string;
    constructor(data?: PartialMessage<Plugin>);
    static readonly runtime: typeof proto3;
    static readonly typeName = "plugins.postgresql.v1.Plugin";
    static readonly fields: FieldList;
