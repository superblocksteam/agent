// Lakebase uses Postgres wire protocol, so we can use standard Postgres queries

export const DEFAULT_SCHEMA_QUERY = `SELECT current_schema();`;

// Query to get table and column metadata
// Uses pg_catalog for performance
...
// Query to get primary and foreign keys
