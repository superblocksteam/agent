...
ifeq ($(QUICKJS_LIB),quickjs-ng)
	...
	# QuickJS 2025-04-26+ removed libbf (bignum extensions) and uses dtoa for float conversion
	QUICKJS_OBJS=quickjs.o libregexp.o libunicode.o cutils.o quickjs-libc.o dtoa.o
