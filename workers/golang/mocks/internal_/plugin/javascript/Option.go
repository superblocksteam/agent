...
import (
	javascript "workers/golang/internal/plugin/javascript"
...
func (_m *Option) Execute(_a0 *javascript.Options) {
	_m.Called(_a0)
}
...
//   - _a0 *javascript.Options
func (_e *Option_Expecter) Execute(_a0 interface{}) *Option_Execute_Call {
	return &Option_Execute_Call{Call: _e.mock.On("Execute", _a0)}
}

func (_c *Option_Execute_Call) Run(run func(_a0 *javascript.Options)) *Option_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*javascript.Options))
	})
	return _c
}
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*javascript.Options)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
