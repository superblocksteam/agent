...
// UpdateResourceWithSignature provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4
func (_m *MockResourceSerializer) UpdateResourceWithSignature(_a0 *v1.Resource, _a1 string, _a2 utilsv1.Signature_Algorithm, _a3 []byte, _a4 []byte) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*v1.Resource, string, utilsv1.Signature_Algorithm, []byte, []byte) error); ok {
