	...
	tests := []struct {
	...
	}{
		{
			...
			zapFields: []zap.Field{
				...
				zap.String("targetName", "test-target-name"),
				zap.String("apiRunStatus", agentv1.AuditLogRequest_AuditLog_API_RUN_STATUS_FAILED.String()),
			...
			expectedLog: &agentv1.AuditLogRequest_AuditLog{
				...
				Source:         "test-source",
				Target:         "test-target",
				TargetName:     proto.String("test-target-name"),
		...
		},
		{
			...
			zapFields: []zap.Field{
				...
				zap.String("apiRunStatus", agentv1.AuditLogRequest_AuditLog_API_RUN_STATUS_SUCCESS.String()),
