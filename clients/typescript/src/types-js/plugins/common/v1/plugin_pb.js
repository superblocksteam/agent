...
proto.plugins.common.v1.AWSConfig.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getAuth();
  if (f != null) {
    writer.writeMessage(2, f, proto.plugins.common.v1.AWSConfig.Auth.serializeBinaryToWriter);
  }
};
    ...
    var f,
      obj = {
        ...
        mappedColumnsList: jspb.Message.toObjectList(
          ...
          proto.plugins.common.v1.SQLMappedColumns.toObject,
          includeInstance
        ),
...
proto.plugins.common.v1.SQLBulkEdit.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(8, f, proto.plugins.common.v1.SQLMappedColumns.serializeBinaryToWriter);
  }
  f = /** @type {string} */ (jspb.Message.getField(message, 9));
  if (f != null) {
    writer.writeString(9, f);
