...
proto.plugins.smtp.v1.Plugin.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.plugins.smtp.v1.Plugin.SmtpConnection.serializeBinaryToWriter);
  }
  f = message.getFrom();
  if (f.length > 0) {
  ...
  if (f != null) {
    writer.writeMessage(11, f, plugins_common_v1_plugin_pb.DynamicWorkflowConfiguration.serializeBinaryToWriter);
  }
};
