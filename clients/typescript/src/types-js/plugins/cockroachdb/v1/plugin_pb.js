    ...
    var f,
      obj = {
        ...
        mappedcolumnsList: jspb.Message.toObjectList(
          ...
          proto.plugins.cockroachdb.v1.MappedColumns.toObject,
          includeInstance
        ),
        superblocksmetadata:
          (f = msg.getSuperblocksmetadata()) && proto.plugins.cockroachdb.v1.SuperblocksMetadata.toObject(includeInstance, f),
...
proto.plugins.cockroachdb.v1.Plugin.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(10, f, proto.plugins.cockroachdb.v1.MappedColumns.serializeBinaryToWriter);
  }
  f = message.getSuperblocksmetadata();
  if (f != null) {
    writer.writeMessage(11, f, proto.plugins.cockroachdb.v1.SuperblocksMetadata.serializeBinaryToWriter);
  }
