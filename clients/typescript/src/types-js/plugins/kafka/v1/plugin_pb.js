...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.plugins.kafka.v1.Metadata.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        topicsList: jspb.Message.toObjectList(msg.getTopicsList(), proto.plugins.kafka.v1.Topic.toObject, includeInstance),
        brokersList: jspb.Message.toObjectList(msg.getBrokersList(), proto.plugins.kafka.v1.Broker.toObject, includeInstance)
      };
...
proto.plugins.kafka.v1.Metadata.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.plugins.kafka.v1.Topic.serializeBinaryToWriter);
  }
  f = message.getBrokersList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(2, f, proto.plugins.kafka.v1.Broker.serializeBinaryToWriter);
  }
};
...
proto.plugins.kafka.v1.Metadata.prototype.getTopicsList = function () {
  return /** @type{!Array<!proto.plugins.kafka.v1.Topic>} */ (jspb.Message.getRepeatedWrapperField(this, proto.plugins.kafka.v1.Topic, 1));
};
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.plugins.kafka.v1.Messages.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        messagesList: jspb.Message.toObjectList(msg.getMessagesList(), proto.plugins.kafka.v1.Message.toObject, includeInstance)
      };
...
proto.plugins.kafka.v1.Messages.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.plugins.kafka.v1.Message.serializeBinaryToWriter);
  }
};
...
proto.plugins.kafka.v1.Message.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getKey();
  if (f != null) {
    writer.writeMessage(5, f, google_protobuf_struct_pb.Value.serializeBinaryToWriter);
  }
  f = message.getValue();
  if (f != null) {
    writer.writeMessage(6, f, google_protobuf_struct_pb.Value.serializeBinaryToWriter);
  }
  f = message.getLength();
  if (f !== 0) {
...
proto.plugins.kafka.v1.Message.prototype.getKey = function () {
  return /** @type{?proto.google.protobuf.Value} */ (jspb.Message.getWrapperField(this, google_protobuf_struct_pb.Value, 5));
};
...
proto.plugins.kafka.v1.Message.prototype.getValue = function () {
  return /** @type{?proto.google.protobuf.Value} */ (jspb.Message.getWrapperField(this, google_protobuf_struct_pb.Value, 6));
};
...
proto.plugins.kafka.v1.Cluster.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getSasl();
  if (f != null) {
    writer.writeMessage(3, f, proto.plugins.kafka.v1.SASL.serializeBinaryToWriter);
  }
};
...
proto.plugins.kafka.v1.Cluster.prototype.getSasl = function () {
  return /** @type{?proto.plugins.kafka.v1.SASL} */ (jspb.Message.getWrapperField(this, proto.plugins.kafka.v1.SASL, 3));
};
...
proto.plugins.kafka.v1.Plugin.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(3, f, proto.plugins.kafka.v1.Plugin.Produce.serializeBinaryToWriter);
  }
  f = message.getConsume();
  if (f != null) {
    writer.writeMessage(4, f, proto.plugins.kafka.v1.Plugin.Consume.serializeBinaryToWriter);
  }
  f = message.getCluster();
  if (f != null) {
    writer.writeMessage(5, f, proto.plugins.kafka.v1.Cluster.serializeBinaryToWriter);
  }
  f = message.getSuperblocksmetadata();
  if (f != null) {
    writer.writeMessage(6, f, proto.plugins.kafka.v1.SuperblocksMetadata.serializeBinaryToWriter);
  }
  f = message.getDynamicWorkflowConfiguration();
  if (f != null) {
    writer.writeMessage(7, f, plugins_common_v1_plugin_pb.DynamicWorkflowConfiguration.serializeBinaryToWriter);
  }
};
...
proto.plugins.kafka.v1.Plugin.Consume.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getSeek();
  if (f != null) {
    writer.writeMessage(5, f, proto.plugins.kafka.v1.Plugin.Consume.Seek.serializeBinaryToWriter);
  }
...
proto.plugins.kafka.v1.Plugin.prototype.getCluster = function () {
  return /** @type{?proto.plugins.kafka.v1.Cluster} */ (jspb.Message.getWrapperField(this, proto.plugins.kafka.v1.Cluster, 5));
};
