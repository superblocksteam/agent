...
proto.plugins.salesforce.v1.Plugin.prototype.getSalesforceActionCase = function () {
  return /** @type {proto.plugins.salesforce.v1.Plugin.SalesforceActionCase} */ (
    jspb.Message.computeOneofCase(this, proto.plugins.salesforce.v1.Plugin.oneofGroups_[0])
  );
};
...
proto.plugins.salesforce.v1.Plugin.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.plugins.salesforce.v1.Plugin.SalesforceConnection.serializeBinaryToWriter);
  }
  f = message.getSoql();
  if (f != null) {
    writer.writeMessage(3, f, proto.plugins.salesforce.v1.Plugin.Soql.serializeBinaryToWriter);
  }
  f = message.getCrud();
  if (f != null) {
    writer.writeMessage(4, f, proto.plugins.salesforce.v1.Plugin.Crud.serializeBinaryToWriter);
  }
  f = message.getBulk();
  if (f != null) {
    writer.writeMessage(5, f, proto.plugins.salesforce.v1.Plugin.Bulk.serializeBinaryToWriter);
  }
...
proto.plugins.salesforce.v1.Plugin.SalesforceConnection.serializeBinaryToWriter = function (message, writer) {
  ...
  f = message.getAuth();
  if (f != null) {
    writer.writeMessage(2, f, plugins_common_v1_auth_pb.Auth.serializeBinaryToWriter);
  }
};
...
proto.plugins.salesforce.v1.Plugin.SalesforceConnection.prototype.getAuth = function () {
  return /** @type{?proto.plugins.common.v1.Auth} */ (jspb.Message.getWrapperField(this, plugins_common_v1_auth_pb.Auth, 2));
};
    ...
    var f,
      obj = {
        objectsList: jspb.Message.toObjectList(
          msg.getObjectsList(),
          proto.plugins.salesforce.v1.Plugin.Metadata.Object.toObject,
          includeInstance
        )
      };
...
proto.plugins.salesforce.v1.Plugin.Metadata.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.plugins.salesforce.v1.Plugin.Metadata.Object.serializeBinaryToWriter);
  }
};
    ...
    var f,
      obj = {
        fieldsList: jspb.Message.toObjectList(
          msg.getFieldsList(),
          proto.plugins.salesforce.v1.Plugin.Metadata.Object.Field.toObject,
          includeInstance
        )
      };
...
proto.plugins.salesforce.v1.Plugin.Metadata.Object.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.plugins.salesforce.v1.Plugin.Metadata.Object.Field.serializeBinaryToWriter);
  }
};
