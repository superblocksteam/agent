...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.buf.validate.priv.FieldConstraints.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        celList: jspb.Message.toObjectList(msg.getCelList(), proto.buf.validate.priv.Constraint.toObject, includeInstance)
      };
...
proto.buf.validate.priv.FieldConstraints.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.buf.validate.priv.Constraint.serializeBinaryToWriter);
  }
};
...
proto.buf.validate.priv.field = new jspb.ExtensionFieldInfo(
  ...
  /** @type {?function((boolean|undefined),!jspb.Message=): !Object} */ (proto.buf.validate.priv.FieldConstraints.toObject),
  0
);
