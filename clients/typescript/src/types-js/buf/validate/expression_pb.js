...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.buf.validate.Violations.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        violationsList: jspb.Message.toObjectList(msg.getViolationsList(), proto.buf.validate.Violation.toObject, includeInstance)
      };
...
proto.buf.validate.Violations.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, proto.buf.validate.Violation.serializeBinaryToWriter);
  }
};
...
proto.buf.validate.Violations.prototype.getViolationsList = function () {
  return /** @type{!Array<!proto.buf.validate.Violation>} */ (jspb.Message.getRepeatedWrapperField(this, proto.buf.validate.Violation, 1));
};
