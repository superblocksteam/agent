...
interface IExecutorServiceService_ITwoWayStream
  extends grpc.MethodDefinition<api_v1_service_pb.TwoWayRequest, api_v1_service_pb.TwoWayResponse> {
...
interface IExecutorServiceService_IMetadataDeprecated
  extends grpc.MethodDefinition<api_v1_service_pb.MetadataRequestDeprecated, api_v1_service_pb.MetadataResponse> {
...
interface IExecutorServiceService_IMetadata
  extends grpc.MethodDefinition<api_v1_service_pb.MetadataRequest, api_v1_service_pb.MetadataResponse> {
...
interface IExecutorServiceService_IStream
  extends grpc.MethodDefinition<api_v1_service_pb.ExecuteRequest, api_v1_service_pb.StreamResponse> {
...
interface IExecutorServiceService_IDownload
  extends grpc.MethodDefinition<api_v1_service_pb.DownloadRequest, api_v1_service_pb.DownloadResponse> {
...
interface IExecutorServiceService_IValidate
  extends grpc.MethodDefinition<api_v1_service_pb.ValidateRequest, google_protobuf_empty_pb.Empty> {
...
export interface IExecutorServiceClient {
  await(
    request: api_v1_service_pb.ExecuteRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.AwaitResponse) => void
  ...
  twoWayStream(
    options: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<api_v1_service_pb.TwoWayRequest, api_v1_service_pb.TwoWayResponse>;
  twoWayStream(
    metadata: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientDuplexStream<api_v1_service_pb.TwoWayRequest, api_v1_service_pb.TwoWayResponse>;
  metadataDeprecated(
    request: api_v1_service_pb.MetadataRequestDeprecated,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.MetadataResponse) => void
  ): grpc.ClientUnaryCall;
  metadataDeprecated(
    request: api_v1_service_pb.MetadataRequestDeprecated,
    metadata: grpc.Metadata,
  ...
  metadata(
    request: api_v1_service_pb.MetadataRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.MetadataResponse) => void
  ): grpc.ClientUnaryCall;
  metadata(
    request: api_v1_service_pb.MetadataRequest,
  ...
  test(
    request: api_v1_service_pb.TestRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.TestResponse) => void
  ): grpc.ClientUnaryCall;
  test(
    request: api_v1_service_pb.TestRequest,
    metadata: grpc.Metadata,
  ...
  delete(
    request: api_v1_service_pb.DeleteRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.DeleteResponse) => void
  ): grpc.ClientUnaryCall;
  delete(
    request: api_v1_service_pb.DeleteRequest,
    metadata: grpc.Metadata,
  ...
  async(
    request: api_v1_service_pb.ExecuteRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.AsyncResponse) => void
  ): grpc.ClientUnaryCall;
  async(
    request: api_v1_service_pb.ExecuteRequest,
    metadata: grpc.Metadata,
  ...
  stream(
    request: api_v1_service_pb.ExecuteRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<api_v1_service_pb.StreamResponse>;
  stream(
    request: api_v1_service_pb.ExecuteRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  status(
    request: api_v1_service_pb.StatusRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.AwaitResponse) => void
  ): grpc.ClientUnaryCall;
  status(
    request: api_v1_service_pb.StatusRequest,
  ...
  output(
    request: api_v1_service_pb.OutputRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.OutputResponse) => void
  ): grpc.ClientUnaryCall;
  output(
    request: api_v1_service_pb.OutputRequest,
    metadata: grpc.Metadata,
  ...
  download(
    request: api_v1_service_pb.DownloadRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<api_v1_service_pb.DownloadResponse>;
  download(
    request: api_v1_service_pb.DownloadRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  cancel(
    request: api_v1_service_pb.CancelRequest,
    callback: (error: grpc.ServiceError | null, response: api_v1_service_pb.CancelResponse) => void
  ): grpc.ClientUnaryCall;
  cancel(
    request: api_v1_service_pb.CancelRequest,
    metadata: grpc.Metadata,
  ...
  validate(
    request: api_v1_service_pb.ValidateRequest,
