...
## vNext
- Fix Apps 3.0 SDK integration queries for embedded external users by routing nested integration executions through an internal gRPC service and the agent datasource path.
