...
func (x *CloudEvent) Reset() {
	*x = CloudEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_v1_cloudevent_proto_msgTypes[0]
...
func (*CloudEvent) Descriptor() ([]byte, []int) {
	return file_event_v1_cloudevent_proto_rawDescGZIP(), []int{0}
}
...
func (x *CloudEventAttributeValue) Reset() {
	*x = CloudEventAttributeValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_v1_cloudevent_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CloudEventAttributeValue) Descriptor() ([]byte, []int) {
	return file_event_v1_cloudevent_proto_rawDescGZIP(), []int{1}
}
...
var File_event_v1_cloudevent_proto protoreflect.FileDescriptor

var file_event_v1_cloudevent_proto_rawDesc = []byte{
	0x0a, 0x19, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43,
	...
	0x28, 0x0b, 0x32, 0x22, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6c,
	...
	0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2f, 0x76, 0x31,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_event_v1_cloudevent_proto_rawDescOnce sync.Once
	file_event_v1_cloudevent_proto_rawDescData = file_event_v1_cloudevent_proto_rawDesc
)

func file_event_v1_cloudevent_proto_rawDescGZIP() []byte {
	file_event_v1_cloudevent_proto_rawDescOnce.Do(func() {
		file_event_v1_cloudevent_proto_rawDescData = protoimpl.X.CompressGZIP(file_event_v1_cloudevent_proto_rawDescData)
	})
	return file_event_v1_cloudevent_proto_rawDescData
}

var file_event_v1_cloudevent_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_event_v1_cloudevent_proto_goTypes = []interface{}{
	(*CloudEvent)(nil),               // 0: event.v1.CloudEvent
	(*CloudEventAttributeValue)(nil), // 1: event.v1.CloudEventAttributeValue
	nil,                              // 2: event.v1.CloudEvent.AttributesEntry
	(*anypb.Any)(nil),                // 3: google.protobuf.Any
	(*timestamppb.Timestamp)(nil),    // 4: google.protobuf.Timestamp
}
var file_event_v1_cloudevent_proto_depIdxs = []int32{
	2, // 0: event.v1.CloudEvent.attributes:type_name -> event.v1.CloudEvent.AttributesEntry
	3, // 1: event.v1.CloudEvent.proto_data:type_name -> google.protobuf.Any
	4, // 2: event.v1.CloudEventAttributeValue.ce_timestamp:type_name -> google.protobuf.Timestamp
	1, // 3: event.v1.CloudEvent.AttributesEntry.value:type_name -> event.v1.CloudEventAttributeValue
...
func init() { file_event_v1_cloudevent_proto_init() }
func file_event_v1_cloudevent_proto_init() {
	if File_event_v1_cloudevent_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_event_v1_cloudevent_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_event_v1_cloudevent_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_event_v1_cloudevent_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*CloudEvent_BinaryData)(nil),
		(*CloudEvent_TextData)(nil),
		(*CloudEvent_ProtoData)(nil),
	}
	file_event_v1_cloudevent_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_event_v1_cloudevent_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_event_v1_cloudevent_proto_goTypes,
		DependencyIndexes: file_event_v1_cloudevent_proto_depIdxs,
		MessageInfos:      file_event_v1_cloudevent_proto_msgTypes,
	}.Build()
	File_event_v1_cloudevent_proto = out.File
	file_event_v1_cloudevent_proto_rawDesc = nil
	file_event_v1_cloudevent_proto_goTypes = nil
	file_event_v1_cloudevent_proto_depIdxs = nil
}
