...
// Validate checks the field values on Plugin_SnowflakePostgresConnection with
// the rules defined in the proto definition for this message. If any rules
// are violated, the first error encountered is returned, or nil if there are
// no violations.
func (m *Plugin_SnowflakePostgresConnection) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Plugin_SnowflakePostgresConnection
// with the rules defined in the proto definition for this message. If any
// rules are violated, the result is a list of violation errors wrapped in
// Plugin_SnowflakePostgresConnectionMultiError, or nil if none found.
func (m *Plugin_SnowflakePostgresConnection) ValidateAll() error {
	return m.validate(true)
}

func (m *Plugin_SnowflakePostgresConnection) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for UseSelfSignedSsl
	...
	if len(errors) > 0 {
		return Plugin_SnowflakePostgresConnectionMultiError(errors)
	}

	return nil
}

// Plugin_SnowflakePostgresConnectionMultiError is an error wrapping multiple
// validation errors returned by
// Plugin_SnowflakePostgresConnection.ValidateAll() if the designated
// constraints aren't met.
type Plugin_SnowflakePostgresConnectionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Plugin_SnowflakePostgresConnectionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Plugin_SnowflakePostgresConnectionMultiError) AllErrors() []error { return m }

// Plugin_SnowflakePostgresConnectionValidationError is the validation error
// returned by Plugin_SnowflakePostgresConnection.Validate if the designated
// constraints aren't met.
type Plugin_SnowflakePostgresConnectionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Plugin_SnowflakePostgresConnectionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Plugin_SnowflakePostgresConnectionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Plugin_SnowflakePostgresConnectionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Plugin_SnowflakePostgresConnectionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Plugin_SnowflakePostgresConnectionValidationError) ErrorName() string {
	return "Plugin_SnowflakePostgresConnectionValidationError"
}

// Error satisfies the builtin error interface
func (e Plugin_SnowflakePostgresConnectionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPlugin_SnowflakePostgresConnection.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Plugin_SnowflakePostgresConnectionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = Plugin_SnowflakePostgresConnectionValidationError{}
