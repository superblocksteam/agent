...
func (m *Connection) validate(all bool) error {
	...
	// no validation rules for OverrideS3OutputLocation
	...
	if m.WorkgroupName != nil {
		// no validation rules for WorkgroupName
	}

	if m.S3OutputLocation != nil {
		// no validation rules for S3OutputLocation
	}

	if m.S3OutputLocationSuffix != nil {
		// no validation rules for S3OutputLocationSuffix
	}
