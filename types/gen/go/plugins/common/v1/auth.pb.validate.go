...
func (m *Auth) validate(all bool) error {
	...
	case *Auth_OauthIdpTokenPassthrough:
		if v == nil {
			err := AuthValidationError{
				field:  "Method",
				reason: "oneof value cannot be a typed-nil",
		...
		if all {
			switch v := interface{}(m.GetOauthIdpTokenPassthrough()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AuthValidationError{
						field:  "OauthIdpTokenPassthrough",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetOauthIdpTokenPassthrough()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return AuthValidationError{
					field:  "OauthIdpTokenPassthrough",
					reason: "embedded message failed validation",
