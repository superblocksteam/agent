...
type OAuth_AuthorizationCodeFlow_SubjectTokenSource int32

const (
	OAuth_AuthorizationCodeFlow_SUBJECT_TOKEN_SOURCE_UNSPECIFIED             OAuth_AuthorizationCodeFlow_SubjectTokenSource = 0
	OAuth_AuthorizationCodeFlow_SUBJECT_TOKEN_SOURCE_LOGIN_IDENTITY_PROVIDER OAuth_AuthorizationCodeFlow_SubjectTokenSource = 1
	OAuth_AuthorizationCodeFlow_SUBJECT_TOKEN_SOURCE_STATIC_TOKEN            OAuth_AuthorizationCodeFlow_SubjectTokenSource = 2
)

// Enum value maps for OAuth_AuthorizationCodeFlow_SubjectTokenSource.
var (
	OAuth_AuthorizationCodeFlow_SubjectTokenSource_name = map[int32]string{
		0: "SUBJECT_TOKEN_SOURCE_UNSPECIFIED",
		1: "SUBJECT_TOKEN_SOURCE_LOGIN_IDENTITY_PROVIDER",
		2: "SUBJECT_TOKEN_SOURCE_STATIC_TOKEN",
	}
	OAuth_AuthorizationCodeFlow_SubjectTokenSource_value = map[string]int32{
...
func (x OAuth_AuthorizationCodeFlow_SubjectTokenSource) Enum() *OAuth_AuthorizationCodeFlow_SubjectTokenSource {
	p := new(OAuth_AuthorizationCodeFlow_SubjectTokenSource)
	*p = x
	return p
}

func (x OAuth_AuthorizationCodeFlow_SubjectTokenSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OAuth_AuthorizationCodeFlow_SubjectTokenSource) Descriptor() protoreflect.EnumDescriptor {
	return file_plugins_common_v1_auth_proto_enumTypes[0].Descriptor()
}

func (OAuth_AuthorizationCodeFlow_SubjectTokenSource) Type() protoreflect.EnumType {
	return &file_plugins_common_v1_auth_proto_enumTypes[0]
}

func (x OAuth_AuthorizationCodeFlow_SubjectTokenSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OAuth_AuthorizationCodeFlow_SubjectTokenSource.Descriptor instead.
func (OAuth_AuthorizationCodeFlow_SubjectTokenSource) EnumDescriptor() ([]byte, []int) {
	return file_plugins_common_v1_auth_proto_rawDescGZIP(), []int{1, 2, 0}
}
...
func (x *Auth) GetOauthIdpTokenPassthrough() *Auth_Nothing {
	if x, ok := x.GetMethod().(*Auth_OauthIdpTokenPassthrough); ok {
		return x.OauthIdpTokenPassthrough
	}
	return nil
}
...
type Auth_OauthTokenExchange struct {
	...
	OauthTokenExchange *Auth_Nothing `protobuf:"bytes,6,opt,name=oauth_token_exchange,json=oauthTokenExchange,proto3,oneof"`
}

type Auth_OauthIdpTokenPassthrough struct {
	OauthIdpTokenPassthrough *Auth_Nothing `protobuf:"bytes,7,opt,name=oauth_idp_token_passthrough,json=oauthIdpTokenPassthrough,proto3,oneof"`
}
...
func (*Auth_OauthIdpTokenPassthrough) isAuth_Method() {}
...
type OAuth_AuthorizationCodeFlow struct {
	...
	SubjectTokenSource            OAuth_AuthorizationCodeFlow_SubjectTokenSource `protobuf:"varint,10,opt,name=subject_token_source,json=subjectTokenSource,proto3,enum=plugins.common.v1.OAuth_AuthorizationCodeFlow_SubjectTokenSource" json:"subject_token_source,omitempty"`
	SubjectTokenSourceStaticToken string                                         `protobuf:"bytes,11,opt,name=subject_token_source_static_token,json=subjectTokenSourceStaticToken,proto3" json:"subject_token_source_static_token,omitempty"`
	SubjectTokenType              string                                         `protobuf:"bytes,12,opt,name=subject_token_type,json=subjectTokenType,proto3" json:"subject_token_type,omitempty"`
	WorkforcePoolId               string                                         `protobuf:"bytes,13,opt,name=workforce_pool_id,json=workforcePoolId,proto3" json:"workforce_pool_id,omitempty"`
	WorkforceProviderId           string                                         `protobuf:"bytes,14,opt,name=workforce_provider_id,json=workforceProviderId,proto3" json:"workforce_provider_id,omitempty"`
	BillingProjectNumber          string                                         `protobuf:"bytes,15,opt,name=billing_project_number,json=billingProjectNumber,proto3" json:"billing_project_number,omitempty"`
...
func (x *OAuth_AuthorizationCodeFlow) GetSubjectTokenSource() OAuth_AuthorizationCodeFlow_SubjectTokenSource {
	if x != nil {
		return x.SubjectTokenSource
	}
	return OAuth_AuthorizationCodeFlow_SUBJECT_TOKEN_SOURCE_UNSPECIFIED
}

func (x *OAuth_AuthorizationCodeFlow) GetSubjectTokenSourceStaticToken() string {
	if x != nil {
		return x.SubjectTokenSourceStaticToken
	}
	return ""
}

func (x *OAuth_AuthorizationCodeFlow) GetSubjectTokenType() string {
	if x != nil {
...
func (x *OAuth_AuthorizationCodeFlow) GetWorkforcePoolId() string {
	if x != nil {
...
func (x *OAuth_AuthorizationCodeFlow) GetWorkforceProviderId() string {
	if x != nil {
...
func (x *OAuth_AuthorizationCodeFlow) GetBillingProjectNumber() string {
	if x != nil {
		return x.BillingProjectNumber
	}
	return ""
}

func (x *OAuth_AuthorizationCodeFlow) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
var file_plugins_common_v1_auth_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x22, 0x99, 0x0a, 0x0a, 0x05, 0x4f, 0x41, 0x75, 0x74, 0x68, 0x1a, 0xdc, 0x01, 0x0a,
	...
	0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x1a, 0x85, 0x07, 0x0a, 0x15, 0x41, 0x75, 0x74, 0x68, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_plugins_common_v1_auth_proto_goTypes = []interface{}{
	...
	(*OAuth)(nil),                       // 2: plugins.common.v1.OAuth
	(*Basic)(nil),                       // 3: plugins.common.v1.Basic
	(*Azure)(nil),                       // 4: plugins.common.v1.Azure
	(*AwsAuth)(nil),                     // 5: plugins.common.v1.AwsAuth
	(*GcpAuth)(nil),                     // 6: plugins.common.v1.GcpAuth
	(*AkeylessAuth)(nil),                // 7: plugins.common.v1.AkeylessAuth
	(*Auth)(nil),                        // 8: plugins.common.v1.Auth
	(*OAuth_PasswordGrantFlow)(nil),     // 9: plugins.common.v1.OAuth.PasswordGrantFlow
	(*OAuth_ClientCredentialsFlow)(nil), // 10: plugins.common.v1.OAuth.ClientCredentialsFlow
	(*OAuth_AuthorizationCodeFlow)(nil), // 11: plugins.common.v1.OAuth.AuthorizationCodeFlow
	(*Azure_Key)(nil),                   // 12: plugins.common.v1.Azure.Key
	(*Azure_ClientCredentials)(nil),     // 13: plugins.common.v1.Azure.ClientCredentials
	(*AwsAuth_Static)(nil),              // 14: plugins.common.v1.AwsAuth.Static
...
var file_plugins_common_v1_auth_proto_depIdxs = []int32{
	...
	13, // 1: plugins.common.v1.Azure.client_credentials:type_name -> plugins.common.v1.Azure.ClientCredentials
	14, // 2: plugins.common.v1.AwsAuth.static:type_name -> plugins.common.v1.AwsAuth.Static
	15, // 3: plugins.common.v1.AwsAuth.assume_role:type_name -> plugins.common.v1.AwsAuth.AssumeRole
	16, // 4: plugins.common.v1.AkeylessAuth.api_key:type_name -> plugins.common.v1.AkeylessAuth.ApiKey
	17, // 5: plugins.common.v1.AkeylessAuth.email:type_name -> plugins.common.v1.AkeylessAuth.Email
	9,  // 6: plugins.common.v1.Auth.password_grant_flow:type_name -> plugins.common.v1.OAuth.PasswordGrantFlow
	11, // 7: plugins.common.v1.Auth.authorization_code_flow:type_name -> plugins.common.v1.OAuth.AuthorizationCodeFlow
	...
	18, // 12: plugins.common.v1.Auth.oauth_idp_token_passthrough:type_name -> plugins.common.v1.Auth.Nothing
	0,  // 13: plugins.common.v1.OAuth.AuthorizationCodeFlow.subject_token_source:type_name -> plugins.common.v1.OAuth.AuthorizationCodeFlow.SubjectTokenSource
...
func file_plugins_common_v1_auth_proto_init() {
	...
	file_plugins_common_v1_auth_proto_msgTypes[7].OneofWrappers = []interface{}{
		...
		(*Auth_OauthIdpTokenPassthrough)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_plugins_common_v1_auth_proto_enumTypes,
