...
func (x *Plugin) GetPut() *Plugin_KinesisPut {
	if x, ok := x.GetOperation().(*Plugin_Put); ok {
		return x.Put
	}
	return nil
}
...
func (x *Plugin) GetGet() *Plugin_KinesisGet {
	if x, ok := x.GetOperation().(*Plugin_Get); ok {
		return x.Get
	}
	return nil
}
...
type Plugin_Put struct {
	Put *Plugin_KinesisPut `protobuf:"bytes,3,opt,name=put,proto3,oneof"`
}

type Plugin_Get struct {
	Get *Plugin_KinesisGet `protobuf:"bytes,4,opt,name=get,proto3,oneof"`
}

func (*Plugin_Put) isPlugin_Operation() {}

func (*Plugin_Get) isPlugin_Operation() {}
...
type Plugin_KinesisPut struct {
	...
	//	*Plugin_KinesisPut_StreamArn
	StreamIdentifier isPlugin_KinesisPut_StreamIdentifier `protobuf_oneof:"stream_identifier"`
}
...
func (m *Plugin_KinesisPut) GetStreamIdentifier() isPlugin_KinesisPut_StreamIdentifier {
	if m != nil {
...
func (x *Plugin_KinesisPut) GetStreamName() string {
	if x, ok := x.GetStreamIdentifier().(*Plugin_KinesisPut_StreamName); ok {
		return x.StreamName
	}
	return ""
}
...
func (x *Plugin_KinesisPut) GetStreamArn() string {
	if x, ok := x.GetStreamIdentifier().(*Plugin_KinesisPut_StreamArn); ok {
		return x.StreamArn
	}
	return ""
}

type isPlugin_KinesisPut_StreamIdentifier interface {
	isPlugin_KinesisPut_StreamIdentifier()
}

type Plugin_KinesisPut_StreamName struct {
	StreamName string `protobuf:"bytes,3,opt,name=stream_name,json=streamName,proto3,oneof"`
}

type Plugin_KinesisPut_StreamArn struct {
	StreamArn string `protobuf:"bytes,4,opt,name=stream_arn,json=streamArn,proto3,oneof"`
}

func (*Plugin_KinesisPut_StreamName) isPlugin_KinesisPut_StreamIdentifier() {}

func (*Plugin_KinesisPut_StreamArn) isPlugin_KinesisPut_StreamIdentifier() {}
...
type Plugin_KinesisGet struct {
	...
	// Types that are assignable to StreamIdentifier:
	//
	//	*Plugin_KinesisGet_StreamName
	//	*Plugin_KinesisGet_StreamArn
	StreamIdentifier isPlugin_KinesisGet_StreamIdentifier `protobuf_oneof:"stream_identifier"`
}
...
func (m *Plugin_KinesisGet) GetStreamIdentifier() isPlugin_KinesisGet_StreamIdentifier {
	if m != nil {
		return m.StreamIdentifier
	}
	return nil
...
func (x *Plugin_KinesisGet) GetStreamName() string {
	if x, ok := x.GetStreamIdentifier().(*Plugin_KinesisGet_StreamName); ok {
		return x.StreamName
	}
	return ""
}
...
func (x *Plugin_KinesisGet) GetStreamArn() string {
	if x, ok := x.GetStreamIdentifier().(*Plugin_KinesisGet_StreamArn); ok {
		return x.StreamArn
	}
	return ""
}

type isPlugin_KinesisGet_StreamIdentifier interface {
	isPlugin_KinesisGet_StreamIdentifier()
}

type Plugin_KinesisGet_StreamName struct {
	StreamName string `protobuf:"bytes,8,opt,name=stream_name,json=streamName,proto3,oneof"`
}

type Plugin_KinesisGet_StreamArn struct {
	StreamArn string `protobuf:"bytes,9,opt,name=stream_arn,json=streamArn,proto3,oneof"`
}

func (*Plugin_KinesisGet_StreamName) isPlugin_KinesisGet_StreamIdentifier() {}

func (*Plugin_KinesisGet_StreamArn) isPlugin_KinesisGet_StreamIdentifier() {}
...
var file_plugins_kinesis_v1_plugin_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc3, 0x0a, 0x0a, 0x06, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x67, 0x6f, 0x2f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x73, 0x2f, 0x6b, 0x69, 0x6e, 0x65, 0x73,
...
var file_plugins_kinesis_v1_plugin_proto_goTypes = []interface{}{
	...
	(*Plugin_KinesisPut)(nil),               // 4: plugins.kinesis.v1.Plugin.KinesisPut
	(*Plugin_KinesisGet)(nil),               // 5: plugins.kinesis.v1.Plugin.KinesisGet
...
var file_plugins_kinesis_v1_plugin_proto_depIdxs = []int32{
	...
	4, // 1: plugins.kinesis.v1.Plugin.put:type_name -> plugins.kinesis.v1.Plugin.KinesisPut
	5, // 2: plugins.kinesis.v1.Plugin.get:type_name -> plugins.kinesis.v1.Plugin.KinesisGet
	...
	0, // 5: plugins.kinesis.v1.Plugin.KinesisGet.shard_iterator_type:type_name -> plugins.kinesis.v1.Plugin.ShardIteratorType
...
func file_plugins_kinesis_v1_plugin_proto_init() {
	...
	file_plugins_kinesis_v1_plugin_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Plugin_KinesisPut_StreamName)(nil),
		(*Plugin_KinesisPut_StreamArn)(nil),
	}
	file_plugins_kinesis_v1_plugin_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*Plugin_KinesisGet_StreamName)(nil),
		(*Plugin_KinesisGet_StreamArn)(nil),
	}
	type x struct{}
