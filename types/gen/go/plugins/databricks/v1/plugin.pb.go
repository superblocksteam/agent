...
type Plugin_DatabricksConnection struct {
	...
	ScopedCatalogSchemas []*Plugin_ScopedCatalogSchemas `protobuf:"bytes,10,rep,name=scoped_catalog_schemas,json=scopedCatalogSchemas,proto3" json:"scoped_catalog_schemas,omitempty"`
}
...
func (x *Plugin_DatabricksConnection) GetScopedCatalogSchemas() []*Plugin_ScopedCatalogSchemas {
	if x != nil {
		return x.ScopedCatalogSchemas
	}
	return nil
}

type Plugin_ScopedCatalogSchemas struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Plugin_ScopedCatalogSchemas) Reset() {
	*x = Plugin_ScopedCatalogSchemas{}
	if protoimpl.UnsafeEnabled {
		mi := &file_plugins_databricks_v1_plugin_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Plugin_ScopedCatalogSchemas) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Plugin_ScopedCatalogSchemas) ProtoMessage() {}

func (x *Plugin_ScopedCatalogSchemas) ProtoReflect() protoreflect.Message {
	mi := &file_plugins_databricks_v1_plugin_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Plugin_ScopedCatalogSchemas.ProtoReflect.Descriptor instead.
func (*Plugin_ScopedCatalogSchemas) Descriptor() ([]byte, []int) {
	return file_plugins_databricks_v1_plugin_proto_rawDescGZIP(), []int{0, 1}
}

func (x *Plugin_ScopedCatalogSchemas) GetCatalog() string {
	if x != nil {
		return x.Catalog
	}
	return ""
...
func (x *Plugin_ScopedCatalogSchemas) GetSchemas() []string {
	if x != nil {
		return x.Schemas
	}
	return nil
...
var file_plugins_databricks_v1_plugin_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x85, 0x0a, 0x0a, 0x06,
	...
	0x1a, 0xe7, 0x04, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x62, 0x72, 0x69, 0x63, 0x6b, 0x73, 0x43,
	...
	,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x73, 0x22, 0x87, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
...
var file_plugins_databricks_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_plugins_databricks_v1_plugin_proto_goTypes = []interface{}{
	...
	(*Plugin_ScopedCatalogSchemas)(nil),     // 3: plugins.databricks.v1.Plugin.ScopedCatalogSchemas
	(v1.SQLOperation)(0),                    // 4: plugins.common.v1.SQLOperation
	(*v1.SQLExecution)(nil),                 // 5: plugins.common.v1.SQLExecution
	(*v1.SQLBulkEdit)(nil),                  // 6: plugins.common.v1.SQLBulkEdit
...
var file_plugins_databricks_v1_plugin_proto_depIdxs = []int32{
	...
	4, // 1: plugins.databricks.v1.Plugin.operation:type_name -> plugins.common.v1.SQLOperation
	5, // 2: plugins.databricks.v1.Plugin.run_sql:type_name -> plugins.common.v1.SQLExecution
	6, // 3: plugins.databricks.v1.Plugin.bulk_edit:type_name -> plugins.common.v1.SQLBulkEdit
	7, // 4: plugins.databricks.v1.Plugin.dynamic_workflow_configuration:type_name -> plugins.common.v1.DynamicWorkflowConfiguration
	...
	3, // 6: plugins.databricks.v1.Plugin.DatabricksConnection.scoped_catalog_schemas:type_name -> plugins.databricks.v1.Plugin.ScopedCatalogSchemas
...
func file_plugins_databricks_v1_plugin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_plugins_databricks_v1_plugin_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Plugin_ScopedCatalogSchemas); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
