...
var file_plugins_databricks_v1_plugin_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x05, 0x0a, 0x06,
	...
	0x1a, 0xf0, 0x01, 0x0a, 0x14, 0x44, 0x61, 0x74, 0x61, 0x62, 0x72, 0x69, 0x63, 0x6b, 0x73, 0x43,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x12, 0x0a, 0x10,
	0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67,
	0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x5f, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x42, 0x21, 0x0a, 0x1f, 0x5f, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x5f,
	0x77, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75,
	...
	0x64, 0x61, 0x74, 0x61, 0x62, 0x72, 0x69, 0x63, 0x6b, 0x73, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_plugins_databricks_v1_plugin_proto_goTypes = []interface{}{
	(*Plugin)(nil),                          // 0: plugins.databricks.v1.Plugin
	(*Plugin_DatabricksConnection)(nil),     // 1: plugins.databricks.v1.Plugin.DatabricksConnection
	(v1.SQLOperation)(0),                    // 2: plugins.common.v1.SQLOperation
...
var file_plugins_databricks_v1_plugin_proto_depIdxs = []int32{
	1, // 0: plugins.databricks.v1.Plugin.connection:type_name -> plugins.databricks.v1.Plugin.DatabricksConnection
	2, // 1: plugins.databricks.v1.Plugin.operation:type_name -> plugins.common.v1.SQLOperation
	3, // 2: plugins.databricks.v1.Plugin.run_sql:type_name -> plugins.common.v1.SQLExecution
	4, // 3: plugins.databricks.v1.Plugin.bulk_edit:type_name -> plugins.common.v1.SQLBulkEdit
	5, // 4: plugins.databricks.v1.Plugin.dynamic_workflow_configuration:type_name -> plugins.common.v1.DynamicWorkflowConfiguration
