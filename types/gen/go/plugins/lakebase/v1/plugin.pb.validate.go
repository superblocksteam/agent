...
// Validate checks the field values on Plugin_LakebaseConnection with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *Plugin_LakebaseConnection) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on Plugin_LakebaseConnection with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// Plugin_LakebaseConnectionMultiError, or nil if none found.
func (m *Plugin_LakebaseConnection) ValidateAll() error {
	return m.validate(true)
}

func (m *Plugin_LakebaseConnection) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// Plugin_LakebaseConnectionMultiError is an error wrapping multiple validation
// errors returned by Plugin_LakebaseConnection.ValidateAll() if the
// designated constraints aren't met.
type Plugin_LakebaseConnectionMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m Plugin_LakebaseConnectionMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m Plugin_LakebaseConnectionMultiError) AllErrors() []error { return m }

// Plugin_LakebaseConnectionValidationError is the validation error returned by
// Plugin_LakebaseConnection.Validate if the designated constraints aren't met.
type Plugin_LakebaseConnectionValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e Plugin_LakebaseConnectionValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e Plugin_LakebaseConnectionValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e Plugin_LakebaseConnectionValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e Plugin_LakebaseConnectionValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e Plugin_LakebaseConnectionValidationError) ErrorName() string {
	return "Plugin_LakebaseConnectionValidationError"
}

// Error satisfies the builtin error interface
func (e Plugin_LakebaseConnectionValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPlugin_LakebaseConnection.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = Plugin_LakebaseConnectionValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = Plugin_LakebaseConnectionValidationError{}
