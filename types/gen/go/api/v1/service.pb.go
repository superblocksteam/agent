...
var file_api_v1_service_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x80, 0x0c, 0x0a, 0x10, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x48, 0x00, 0x52, 0x04, 0x61, 0x64, 0x6c, 0x73, 0x12, 0x33, 0x0a, 0x07, 0x67, 0x72, 0x61, 0x70,
	0x68, 0x71, 0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75,
	0x63, 0x74, 0x48, 0x00, 0x52, 0x07, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x12, 0x36, 0x0a,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x88, 0x06, 0x0a, 0x16, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61,
...
var file_api_v1_service_proto_depIdxs = []int32{
	...
	57, // 44: api.v1.MetadataResponse.graphql:type_name -> google.protobuf.Struct
	63, // 45: api.v1.WorkflowResponse.data:type_name -> google.protobuf.Value
	48, // 46: api.v1.WorkflowResponse.response_meta:type_name -> api.v1.WorkflowResponse.ResponseMeta
	50, // 47: api.v1.ExecuteRequest.Fetch.profile:type_name -> common.v1.Profile
	0,  // 48: api.v1.ExecuteRequest.Fetch.view_mode:type_name -> api.v1.ViewMode
	50, // 49: api.v1.ExecuteRequest.FetchByPath.profile:type_name -> common.v1.Profile
	0,  // 50: api.v1.ExecuteRequest.FetchByPath.view_mode:type_name -> api.v1.ViewMode
	63, // 51: api.v1.ExecuteRequest.InputsEntry.value:type_name -> google.protobuf.Value
	64, // 52: api.v1.Definition.Metadata.requester_type:type_name -> common.v1.UserType
	57, // 53: api.v1.Definition.IntegrationsEntry.value:type_name -> google.protobuf.Struct
	63, // 54: api.v1.Function.Request.parameters:type_name -> google.protobuf.Value
	63, // 55: api.v1.Function.Response.value:type_name -> google.protobuf.Value
	53, // 56: api.v1.Function.Response.error:type_name -> common.v1.Error
	63, // 57: api.v1.Mock.Params.inputs:type_name -> google.protobuf.Value
	37, // 58: api.v1.Mock.On.static:type_name -> api.v1.Mock.Params
	63, // 59: api.v1.Mock.Return.static:type_name -> google.protobuf.Value
	46, // 60: api.v1.MetadataResponse.DatabaseSchemaMetadata.tables:type_name -> api.v1.MetadataResponse.DatabaseSchemaMetadata.Table
	47, // 61: api.v1.MetadataResponse.DatabaseSchemaMetadata.schemas:type_name -> api.v1.MetadataResponse.DatabaseSchemaMetadata.Schema
	41, // 62: api.v1.MetadataResponse.BucketsMetadata.buckets:type_name -> api.v1.MetadataResponse.BucketMetadata
	43, // 63: api.v1.MetadataResponse.DatabaseSchemaMetadata.Table.columns:type_name -> api.v1.MetadataResponse.DatabaseSchemaMetadata.Column
	44, // 64: api.v1.MetadataResponse.DatabaseSchemaMetadata.Table.keys:type_name -> api.v1.MetadataResponse.DatabaseSchemaMetadata.Key
	45, // 65: api.v1.MetadataResponse.DatabaseSchemaMetadata.Table.templates:type_name -> api.v1.MetadataResponse.DatabaseSchemaMetadata.Template
	2,  // 66: api.v1.MetadataService.Health:input_type -> api.v1.HealthRequest
	4,  // 67: api.v1.DeprecatedService.Workflow:input_type -> api.v1.ExecuteRequest
	4,  // 68: api.v1.ExecutorService.Await:input_type -> api.v1.ExecuteRequest
	19, // 69: api.v1.ExecutorService.TwoWayStream:input_type -> api.v1.TwoWayRequest
	22, // 70: api.v1.ExecutorService.MetadataDeprecated:input_type -> api.v1.MetadataRequestDeprecated
	23, // 71: api.v1.ExecutorService.Metadata:input_type -> api.v1.MetadataRequest
	14, // 72: api.v1.ExecutorService.Test:input_type -> api.v1.TestRequest
	16, // 73: api.v1.ExecutorService.Delete:input_type -> api.v1.DeleteRequest
	4,  // 74: api.v1.ExecutorService.Async:input_type -> api.v1.ExecuteRequest
	4,  // 75: api.v1.ExecutorService.Stream:input_type -> api.v1.ExecuteRequest
	6,  // 76: api.v1.ExecutorService.Status:input_type -> api.v1.StatusRequest
	10, // 77: api.v1.ExecutorService.Output:input_type -> api.v1.OutputRequest
	25, // 78: api.v1.ExecutorService.Download:input_type -> api.v1.DownloadRequest
	12, // 79: api.v1.ExecutorService.Cancel:input_type -> api.v1.CancelRequest
	3,  // 80: api.v1.ExecutorService.Validate:input_type -> api.v1.ValidateRequest
	65, // 81: api.v1.MetadataService.Health:output_type -> common.v1.HealthResponse
	27, // 82: api.v1.DeprecatedService.Workflow:output_type -> api.v1.WorkflowResponse
	7,  // 83: api.v1.ExecutorService.Await:output_type -> api.v1.AwaitResponse
	20, // 84: api.v1.ExecutorService.TwoWayStream:output_type -> api.v1.TwoWayResponse
	24, // 85: api.v1.ExecutorService.MetadataDeprecated:output_type -> api.v1.MetadataResponse
	24, // 86: api.v1.ExecutorService.Metadata:output_type -> api.v1.MetadataResponse
	15, // 87: api.v1.ExecutorService.Test:output_type -> api.v1.TestResponse
	17, // 88: api.v1.ExecutorService.Delete:output_type -> api.v1.DeleteResponse
	8,  // 89: api.v1.ExecutorService.Async:output_type -> api.v1.AsyncResponse
	9,  // 90: api.v1.ExecutorService.Stream:output_type -> api.v1.StreamResponse
	7,  // 91: api.v1.ExecutorService.Status:output_type -> api.v1.AwaitResponse
	11, // 92: api.v1.ExecutorService.Output:output_type -> api.v1.OutputResponse
	26, // 93: api.v1.ExecutorService.Download:output_type -> api.v1.DownloadResponse
	13, // 94: api.v1.ExecutorService.Cancel:output_type -> api.v1.CancelResponse
	66, // 95: api.v1.ExecutorService.Validate:output_type -> google.protobuf.Empty
