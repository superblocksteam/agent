...
var file_api_v1_api_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x08, 0xf8, 0x42, 0x01, 0xba, 0x48, 0x02, 0x08, 0x01, 0x22, 0x9c,
	0x2f, 0x0a, 0x04, 0x53, 0x74, 0x65, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x67,
	...
	,
...
var file_api_v1_api_proto_depIdxs = []int32{
	...
	12,  // 103: api.v1.Profiles.Modes.editor:type_name -> api.v1.Profiles.Modes.Settings
	12,  // 104: api.v1.Profiles.Modes.preview:type_name -> api.v1.Profiles.Modes.Settings
	12,  // 105: api.v1.Profiles.Modes.deployed:type_name -> api.v1.Profiles.Modes.Settings
	16,  // 106: api.v1.Trigger.Application.options:type_name -> api.v1.Trigger.Application.Options
	17,  // 107: api.v1.Trigger.Workflow.options:type_name -> api.v1.Trigger.Workflow.Options
	18,  // 108: api.v1.Trigger.Workflow.parameters:type_name -> api.v1.Trigger.Workflow.Parameters
	22,  // 109: api.v1.Trigger.Job.options:type_name -> api.v1.Trigger.Job.Options
	1,   // 110: api.v1.Trigger.Job.interval:type_name -> api.v1.Trigger.Job.Interval
	23,  // 111: api.v1.Trigger.Job.days:type_name -> api.v1.Trigger.Job.Days
	86,  // 112: api.v1.Trigger.Job.time:type_name -> google.protobuf.Timestamp
	6,   // 113: api.v1.Trigger.Workflow.Options.profiles:type_name -> api.v1.Profiles
	20,  // 114: api.v1.Trigger.Workflow.Parameters.query:type_name -> api.v1.Trigger.Workflow.Parameters.QueryEntry
	21,  // 115: api.v1.Trigger.Workflow.Parameters.body:type_name -> api.v1.Trigger.Workflow.Parameters.BodyEntry
	19,  // 116: api.v1.Trigger.Workflow.Parameters.QueryEntry.value:type_name -> api.v1.Trigger.Workflow.Parameters.QueryParam
	87,  // 117: api.v1.Trigger.Workflow.Parameters.BodyEntry.value:type_name -> google.protobuf.Value
	6,   // 118: api.v1.Trigger.Job.Options.profiles:type_name -> api.v1.Profiles
	34,  // 119: api.v1.Block.Parallel.static:type_name -> api.v1.Block.Parallel.Static
	35,  // 120: api.v1.Block.Parallel.dynamic:type_name -> api.v1.Block.Parallel.Dynamic
	2,   // 121: api.v1.Block.Parallel.wait:type_name -> api.v1.Block.Parallel.Wait
	38,  // 122: api.v1.Block.Conditional.if:type_name -> api.v1.Block.Conditional.Condition
	38,  // 123: api.v1.Block.Conditional.else_if:type_name -> api.v1.Block.Conditional.Condition
	8,   // 124: api.v1.Block.Conditional.else:type_name -> api.v1.Blocks
	3,   // 125: api.v1.Block.Loop.type:type_name -> api.v1.Block.Loop.Type
	39,  // 126: api.v1.Block.Loop.variables:type_name -> api.v1.Block.Loop.Variables
	9,   // 127: api.v1.Block.Loop.blocks:type_name -> api.v1.Block
	8,   // 128: api.v1.Block.TryCatch.try:type_name -> api.v1.Blocks
	8,   // 129: api.v1.Block.TryCatch.catch:type_name -> api.v1.Blocks
	8,   // 130: api.v1.Block.TryCatch.finally:type_name -> api.v1.Blocks
	40,  // 131: api.v1.Block.TryCatch.variables:type_name -> api.v1.Block.TryCatch.Variables
	43,  // 132: api.v1.Block.Stream.trigger:type_name -> api.v1.Block.Stream.Trigger
	8,   // 133: api.v1.Block.Stream.process:type_name -> api.v1.Blocks
	41,  // 134: api.v1.Block.Stream.variables:type_name -> api.v1.Block.Stream.Variables
	42,  // 135: api.v1.Block.Stream.options:type_name -> api.v1.Block.Stream.Options
	36,  // 136: api.v1.Block.Parallel.Static.paths:type_name -> api.v1.Block.Parallel.Static.PathsEntry
	37,  // 137: api.v1.Block.Parallel.Dynamic.variables:type_name -> api.v1.Block.Parallel.Dynamic.Variables
	9,   // 138: api.v1.Block.Parallel.Dynamic.blocks:type_name -> api.v1.Block
	8,   // 139: api.v1.Block.Parallel.Static.PathsEntry.value:type_name -> api.v1.Blocks
	9,   // 140: api.v1.Block.Conditional.Condition.blocks:type_name -> api.v1.Block
	10,  // 141: api.v1.Block.Stream.Trigger.step:type_name -> api.v1.Step
