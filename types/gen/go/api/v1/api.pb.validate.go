...
func (m *Step) validate(all bool) error {
	...
	case *Step_OpenaiV2:
		...
		if all {
			switch v := interface{}(m.GetOpenaiV2()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StepValidationError{
						field:  "OpenaiV2",
		...
		} else if v, ok := interface{}(m.GetOpenaiV2()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return StepValidationError{
					field:  "OpenaiV2",
					reason: "embedded message failed validation",
	...
	case *Step_Lakebase:
		...
		if all {
			switch v := interface{}(m.GetLakebase()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StepValidationError{
						field:  "Lakebase",
		...
		} else if v, ok := interface{}(m.GetLakebase()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return StepValidationError{
					field:  "Lakebase",
					reason: "embedded message failed validation",
	...
	case *Step_Javascriptsdkapi:
		...
		if all {
			switch v := interface{}(m.GetJavascriptsdkapi()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StepValidationError{
						field:  "Javascriptsdkapi",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetJavascriptsdkapi()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return StepValidationError{
					field:  "Javascriptsdkapi",
					reason: "embedded message failed validation",
	...
	case *Step_Snowflakepostgres:
		...
		if all {
			switch v := interface{}(m.GetSnowflakepostgres()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StepValidationError{
						field:  "Snowflakepostgres",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetSnowflakepostgres()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return StepValidationError{
					field:  "Snowflakepostgres",
					reason: "embedded message failed validation",
	...
	case *Step_Snowflakecortex:
		...
		if all {
			switch v := interface{}(m.GetSnowflakecortex()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, StepValidationError{
						field:  "Snowflakecortex",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetSnowflakecortex()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return StepValidationError{
					field:  "Snowflakecortex",
					reason: "embedded message failed validation",
