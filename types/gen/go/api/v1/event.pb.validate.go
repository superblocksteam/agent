...
func (m *IntegrationDiagnostic) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, IntegrationDiagnosticValidationError{
					field:  "Metadata",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// Validate checks the field values on TraceMetadata with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *TraceMetadata) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TraceMetadata with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in TraceMetadataMultiError, or
// nil if none found.
func (m *TraceMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *TraceMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TraceMetadataMultiError(errors)
	}

	return nil
}

// TraceMetadataMultiError is an error wrapping multiple validation errors
// returned by TraceMetadata.ValidateAll() if the designated constraints
// aren't met.
type TraceMetadataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TraceMetadataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TraceMetadataMultiError) AllErrors() []error { return m }

// TraceMetadataValidationError is the validation error returned by
// TraceMetadata.Validate if the designated constraints aren't met.
type TraceMetadataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TraceMetadataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TraceMetadataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TraceMetadataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TraceMetadataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TraceMetadataValidationError) ErrorName() string { return "TraceMetadataValidationError" }

// Error satisfies the builtin error interface
func (e TraceMetadataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = TraceMetadataValidationError{}
