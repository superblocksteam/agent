...
func (x *Signature) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_security_v1_security_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2f, 0x76, 0x31, 0x2f, 0x73, 0x65,
	0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x73, 0x65,
	0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x22, 0x31, 0x0a, 0x09, 0x53, 0x69, 0x67,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x35, 0x5a, 0x33,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x75, 0x70, 0x65, 0x72,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x74, 0x65, 0x61, 0x6d, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73,
...
var (
	...
	file_security_v1_security_proto_rawDescData = file_security_v1_security_proto_rawDesc
)

func file_security_v1_security_proto_rawDescGZIP() []byte {
	file_security_v1_security_proto_rawDescOnce.Do(func() {
		file_security_v1_security_proto_rawDescData = protoimpl.X.CompressGZIP(file_security_v1_security_proto_rawDescData)
	})
...
var file_security_v1_security_proto_goTypes = []interface{}{
	(*Signature)(nil), // 0: security.v1.Signature
}
...
func file_security_v1_security_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_security_v1_security_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_security_v1_security_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_security_v1_security_proto_rawDesc = nil
