...
class Plugin(_message.Message):
    __slots__ = ("body", "usePreparedSql", "operation", "useAdvancedMatching", "table", "newValues", "oldValues", "filterBy", "mappingMode", "mappedColumns", "httpMethod", "superblocksMetadata")
