...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZAgithub.com/superblocksteam/agent/types/gen/go/plugins/pinecone/v1'
