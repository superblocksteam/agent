...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z>github.com/superblocksteam/agent/types/gen/go/plugins/redis/v1'
