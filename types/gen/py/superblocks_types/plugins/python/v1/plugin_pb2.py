...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x1eplugins/python/v1/plugin.proto\x12\x11plugins.python.v1\";\n\x13SuperblocksMetadata\x12$\n\rpluginVersion\x18\x01 \x01(\tR\rpluginVersion\"v\n\x06Plugin\x12\x12\n\x04\x62ody\x18\x01 \x01(\tR\x04\x62ody\x12X\n\x13superblocksMetadata\x18\x02 \x01(\x0b\x32&.plugins.python.v1.SuperblocksMetadataR\x13superblocksMetadataBAZ?github.com/superblocksteam/agent/types/gen/go/plugins/python/v1b\x06proto3')
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z?github.com/superblocksteam/agent/types/gen/go/plugins/python/v1'
