...
proto.plugins.couchbase.v1.Plugin.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.plugins.couchbase.v1.Plugin.CouchbaseEndpoint.serializeBinaryToWriter
    );
  }
 ...
 * @return {!proto.plugins.couchbase.v1.Plugin.CouchbaseConnection} returns this
 */
proto.plugins.couchbase.v1.Plugin.CouchbaseConnection.prototype.clearUrl = function() {
 ...
 * @return {boolean}
 */
proto.plugins.couchbase.v1.Plugin.CouchbaseConnection.prototype.hasUrl = function() {
